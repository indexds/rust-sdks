...
## [0.4.10](https://github.com/indexds/rust-sdks/compare/rust-sdks/livekit-api@0.4.9...rust-sdks/livekit-api@0.4.10) - 2025-11-08

### Added

- add outbound trunk config for create_sip_participant. ([#771](https://github.com/indexds/rust-sdks/pull/771))
